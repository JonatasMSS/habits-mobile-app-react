...
import { generateProgressPercentage } from "../utils/generat-progress-percentage";
...
export function Habit() {
    ...
    const habitProgress = dayInfo?.possibleHabits ? generateProgressPercentage(dayInfo.possibleHabits.length,completedHabits.length):0;
